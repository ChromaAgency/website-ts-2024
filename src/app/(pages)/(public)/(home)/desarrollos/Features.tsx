      ...
      <div className="container">
        <div>
          <div className="grid lg:grid-cols-2 grid-cols-1 2xl:gap-24 gap-10 items-center">
            ...
            >
              <Image alt="desktop1" width={496} height={372} src="/assets/images/simpliroute.avif" />
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 grid-cols-1 2xl:gap-24 gap-10 items-center">
            <div>
              <Image
                ...
                width={496}
                height={335}
                src="/assets/images/producteca.png"
                data-aos="fade-right"
                data-aos-duration={600}
              />
            </div>
        ...
        <div>
          <div className="grid lg:grid-cols-2 grid-cols-1 2xl:gap-24 gap-10 items-center">
            ...
            <div
              ...
              data-aos-duration={700}
            >
              <Image alt="desktop1" width={496} height={372} src="/assets/images/verifarma.png" />
            </div>
          </div>
        </div>
      </div>
