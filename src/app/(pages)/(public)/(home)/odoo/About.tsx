      ...
      <div className="container" data-aos="fade-up">
        <div className="grid lg:grid-cols-3 grid-cols-1 gap-10">
          <div className="flex flex-col items-center justify-between lg:items-start">
            <div className="mb-7 w-1/5 border-t-2 border-brand" />
            <h1 className="text-3xl text-brand">Un software empresarial bien hecho.</h1>
          </div>
          <div>
            <p className="text-sm/relaxed tracking-wider text-slate-700">
